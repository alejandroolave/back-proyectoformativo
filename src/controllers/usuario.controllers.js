...
export const registrarUsuario = async (req, res) => {
    try {
        ...
        const { identificacion, nombres, apellidos, telefono, correo, rol } = req.body;
        const contraseña = identificacion;

        const sql = `INSERT INTO usuario(identificacion, nombres, apellidos, telefono, correo, contraseña, rol) 
                     VALUES (?, ?, ?, ?, ?, ?, ?)`;
        const values = [identificacion, nombres, apellidos, telefono, correo, contraseña, rol];
...
export const actualizarUsuario = async (req, res) => {
    try {
        ...
        let { identificacion, nombres, apellidos, telefono, correo, estado, contrasena, rol } = req.body;

        let sql = `UPDATE usuario SET identificacion='${identificacion}', nombres='${nombres}', apellidos='${apellidos}', telefono= '${telefono}', correo='${correo}', estado='${estado}', contraseña='${contrasena}', rol='${rol}'
        WHERE id_usuario= ${id}`;
